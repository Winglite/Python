...
#Copy - Copia o dicionario (não interfere no original)
...
#Fromkeys - Cria chaves no dicionario
...
#Get - Busca no dicionario, se não existir tras None ou o que você definir
...
#Keys - Mostra todas a chaves do dicionario
...
#Pop - Remove um dado do dicionario
...
resultado = contatos.pop("guilherme@gmail.com", {"Texto se não encontrar"})  # {}
print(resultado)
...
#Set Default - Adiciona um elemento, caso não exista
...
#In - Saber se uma chave existe ou não no dicionario
...
#Del - Remove elementos do dicionario
